...
TOPDIR=/N/dc2/projects/lifebid/Concussion/concussion_real/$SUBJ/diffusion_data/1000
...
## convert dwi's 
mrconvert $TOPDIR/$DWIFILENAME.nii.gz $OUTDIR/${DWIFILENAME}_dwi.mif
...
## fit tensors
cp -v $TOPDIR/dwi.b $OUTDIR/${DWIFILENAME}.b
